...
<section class="privacy-lead-wrapper">
	<div class="l-container">
		<div class="l-row">
			<div class="l-grid-8">
				<div class="privacy-lead-box">

					<dl class="privasy-list">
						<dd class="privacy-listin-title">第1条（プライバシー情報）</dd>
						<dt class="privacy-listin-lead">
					...
					<dl class="privasy-list">
						<dd class="privacy-listin-title">第２条（プライバシー情報の収集方法）</dd>
						<dt class="privacy-listin-lead">
							当社は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。<br>
							また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や，決済に関する情報を当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。<br>
					...
					<dl class="privasy-list">
						<dd class="privacy-listin-title">第３条（個人情報を収集・利用する目的）</dd>
						<dt class="privacy-listin-lead">
					...
					<dl class="privasy-list">
						<dd class="privacy-listin-title">第４条（個人情報の第三者提供）</dd>
						<dt class="privacy-listin-lead">
					...
					<dl class="privasy-list">
						<dd class="privacy-listin-title">第５条（個人情報の開示）</dd>
						<dt class="privacy-listin-lead">
							当社は，本人から個人情報の開示を求められたときは，本人に対し，遅滞なくこれを開示します。ただし，開示することにより次のいずれかに該当する場合は，その全部または一部を開示しないこともあり，開示しない決定をした場合には，その旨を遅滞なく通知します。<br>なお，個人情報の開示に際しては，１件あたり１，０００円の手数料を申し受けます。<br>
					...
					<dl class="privasy-list">
						<dd class="privacy-listin-title">第６条（個人情報の訂正および削除）</dd>
						<dt class="privacy-listin-lead">
					...
					<dl class="privasy-list">
						<dd class="privacy-listin-title">第７条（個人情報の利用停止等）</dd>
						<dt class="privacy-listin-lead">
					...
					<dl class="privasy-list">
						<dd class="privacy-listin-title">第８条（プライバシーポリシーの変更）</dd>
						<dt class="privacy-listin-lead">
